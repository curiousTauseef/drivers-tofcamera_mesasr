...
{
  DWORD objID;           //!<object ID of the object that should/has been read
  DWORD objSize;         //!<size of the object that has been read.
...
{
  HWND _parent;      //!< handle to the parent window
